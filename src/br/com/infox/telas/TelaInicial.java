...
import br.com.infox.telas.TelaOS;
...
public class TelaInicial extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        layout.setVerticalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                .addComponent(desktop, javax.swing.GroupLayout.PREFERRED_SIZE, 448, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addGap(0, 0, Short.MAX_VALUE))
        );

        setSize(new java.awt.Dimension(947, 510));
        setLocationRelativeTo(null);
    }// </editor-fold>//GEN-END:initComponents

    private void formWindowActivated(java.awt.event.WindowEvent evt) {//GEN-FIRST:event_formWindowActivated
        // Linhas abaixo substiuem a lavel data lblData pela data atual do sistema ao inicializar o form
        Date data = new Date();
    ...
    private void menCadUsuActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_menCadUsuActionPerformed
         // as linha abaixo vão abrir o form Tela Usuario dentro do Desktop PAne
         ...
         int confirma = JOptionPane.showConfirmDialog(null, "Confirma a impressão deste relatorio?", "Atenção", JOptionPane.YES_NO_OPTION);
           if (confirma == JOptionPane.YES_OPTION) {
            ...
            try {
                ...
                // linha abaixo exibe o relatório atraves da classe JasperViewer
